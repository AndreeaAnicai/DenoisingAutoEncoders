...
def main():
    ...
    df_nines = pd.read_csv('../../data/final_output_files/onlyNumericValues.csv', low_memory=False)
    nines_array = df_nines.values
    print(nines_array.shape)
    nines_array = nines_array[:-4, :-2]

    df_zeros = pd.read_csv('../../data/final_output_files/onlyNumericValuesZeros.csv', low_memory=False)
